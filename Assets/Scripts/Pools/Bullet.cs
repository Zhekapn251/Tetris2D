...
public class Bullet : MonoBehaviour
{
    ...
    private PoolOfBullets poolOfBullets;

    public void Init(PoolOfBullets poolOfBullets)
    {
        this.poolOfBullets = poolOfBullets;
    }
    ...
    private void ReturnToPool()
    {
        ...
        poolOfBullets.ReturnBullet(this);
    }
    ...
    public void FireBullet(Vector3Int start, Vector3Int distance)
    {
        ...
        Vector3 distancePosition = new Vector3(distance.x + 0.5f, distance.y+0.5f, 0);//0.5f
